...
parser.add_argument('--logdir', default='testfordtc', type=str, help='directory to save the tensorboard logs')
...
parser.add_argument('--model_name', default='vnet', type=str, help='model name')
...
def main_worker(gpu, args):
    ...
    if (args.model_name is None) or args.model_name == 'vnet':
