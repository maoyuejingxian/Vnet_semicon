...
#                              .format(input.dim()))
#         print(input.shape)
#         super(ContBatchNorm3d, self)._check_input_dim(input)#######################not run
...
class OutputTransition(nn.Module):########################################                      need to be change,4 or 5,,or the size cannot be matched
